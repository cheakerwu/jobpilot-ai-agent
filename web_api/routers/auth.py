...
@router.put("/password")
async def change_password(req: PasswordRequest, request: Request, current_user: User = Depends(get_current_user)):
    """修改密码"""
    _check_rate_limit(request, "change_password", max_requests=5, window_seconds=60)
